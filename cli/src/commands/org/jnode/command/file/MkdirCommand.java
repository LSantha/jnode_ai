...
public class MkdirCommand extends AbstractCommand {
    ...
    private static final String help_parents = "no error if existing, make parent directories as needed";
    ...
    private static final String err_exists_not_dir = "Cannot create directory: path exists and is not a directory";
    ...
    public void execute() {
        ...
        if (argParents.isSet()) {
            if (dir.exists()) {
                ...
                err.println(err_exists_not_dir);
                exit(1);
            }
            if (!dir.mkdirs()) {
